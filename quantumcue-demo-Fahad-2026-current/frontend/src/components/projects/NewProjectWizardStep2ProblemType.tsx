/**
 * New Project Wizard Step 2: Problem Type Selection
 */
...
interface NewProjectWizardStep2ProblemTypeProps {
...
export const NewProjectWizardStep2ProblemType = ({ data, onUpdate }: NewProjectWizardStep2ProblemTypeProps) => {
  return (
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Describe your quantum computing project..."
            rows={4}
            className="w-full px-3 py-2 bg-surface border border-border rounded-lg text-black placeholder:text-text-tertiary hover:border-border-subtle focus:outline-none focus:ring-2 focus:ring-navy-700 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
